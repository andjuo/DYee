...
namespace DYTools {
  ...
  typedef enum { SYST_MODE_FAILURE=0, NO_SYST, RESOLUTION_STUDY, FSR_STUDY, ESCALE_RESIDUAL, ESCALE_STUDY, ESCALE_STUDY_RND, UNREGRESSED_ENERGY, SYST_RND, TAG_ID, TAG_PT, PILEUP_5plus, PILEUP_5minus, UNREG_PU5plus, UNREG_PU5minus, UNREG_TagID, UNREG_TagPt } TSystematicsStudy_t;
