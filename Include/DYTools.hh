...
namespace DYTools {
  ...
  typedef enum { SYST_MODE_FAILURE=0, NO_SYST, RESOLUTION_STUDY, FSR_STUDY, FSR_5plus, FSR_5minus, APPLY_ESCALE, ESCALE_RESIDUAL, ESCALE_STUDY, ESCALE_STUDY_RND, UNREGRESSED_ENERGY, NO_REWEIGHT, NO_REWEIGHT_PU, NO_REWEIGHT_FEWZ, SYST_RND, TAG_ID, TAG_PT, PU_STUDY, PILEUP_5plus, PILEUP_5minus, UNREG_PU5plus, UNREG_PU5minus, UNREG_TagID, UNREG_TagPt } TSystematicsStudy_t;
