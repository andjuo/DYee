...
namespace DYTools {
  ...
  typedef enum { SYST_MODE_FAILURE=0, NO_SYST, RESOLUTION_STUDY, FSR_STUDY, ESCALE_RESIDUAL, ESCALE_STUDY, ESCALE_STUDY_RND, SYST_RND, PILEUP_5plus, PILEUP_5minus } TSystematicsStudy_t;
