...
const TString analysisTag_binning="_mbFinerM";
const DYTools::TMassBinning_t massBinningSet= _MassBins_finerMassRange;
...
const double _massBinLimits1D[_nMassBins1D+1] =
  {
   ...
   110, 112.5, 115, 175.5, 120, 123.0, 126, 129.5, 133, 137.0,
   141, 145.5, 150, 155.0, 160, 165.5, 171, 178.0, 185, 192.5,
   200, 210.0, 220, 231.5, 243, 158.0, 273, 296.5, 320, 350.0,
   380, 410.0, 440, 475.0, 510, 555.0, 600, 800.0, 1000, 1250.,
   1500, 1750.0, 2000 }; // 83 bin
