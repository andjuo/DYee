...
[DEFINITIONS]
PATH_1=/media/sdb4/CMSData2012-A
PATH_2=/media/sdb3/CMSData2012-B
PATH_3=
PATH_4=
...
SelectionTag   = DY_j22_19789pb
ConstantsTag   = DY_j22_19789pb
XSecTag        = DY_j22_19789pb
...
#T&P_TAG=Date20130529_2012_j22_adhoc // ignored
...
[DATA_FILES]
$ data 1  1 1 1  @data
PATH_1/r12a-del-j22-v1_tight-loose_skim.root  0 PATH_5/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt
PATH_1/r12b-del-j22-v1_tight-loose_skim.root  0 PATH_5/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt
PATH_1/r12c-del-j22-v1_tight-loose_skim.root  0 PATH_5/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt
PATH_1/r12d-del-j22-v1_tight-loose_skim.root  0 PATH_5/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt
%
...
#PATH_1/s12-tt2l-mg-v7c_tight-loose_skim.root 25.80
#
...
#     (note: for madgraph ttbar->2lX sample above, the fraction >700 is a bit
#      different, but the PREP number is used here).
...
#    https://twiki.cern.ch/twiki/bin/viewauth/CMS/StandardModelCrossSectionsat8TeV
#
PATH_1/s12-wjets-v7a_tight-loose_skim.root 37509.0
...
PATH_1/s12-wwj-v7a_ntuple.root 5.812
...
# PATH_1/s12-wz-v7a_tight-loose_skim.root = 22.4
#
...
PATH_2/s12-ztt20_tight-loose_skim.root 1915.1
...
#PATH_1/s12-zeem20-v7a_tight-loose_skim.root 1915.1
#
# In case we use 20-500-800-inf:
#
PATH_1/s12-zeem20to500-v7a_tight-loose_skim.root 1915.1  600  @Powheg 20-500
#
PATH_1/s12-zeem500to800-v7a_ntuple.root 0.039509  632 @Powheg 500-800
#
PATH_1/s12-zeem800-v7a_ntuple.root 0.005620   432 @Powheg 800+
#
# In case we use 20-500-inf:
#PATH_1/s12-zeem500-v7a_ntuple.root 0.045129
#
PATH_1/s12-zeem1020-v7a_tight-loose_skim.root 3795.4  800 @Powheg 10-20
%
