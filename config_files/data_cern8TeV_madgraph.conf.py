...
[DEFINITIONS]
PATH_1=/tmp/andriusj/data
PATH_2=/tmp/andriusj/data
PATH_3=/tmp/andriusj/data
PATH_4=
PATH_5=../config_files/JSONs/8TeV/
PATH_SSD=/tmp/andriusj/data
NTUPLE=ntuple
...
SelectionTag   = DY_j22_19712pb
ConstantsTag   = DY_j22_19712pb
...
#
#a PATH_SSD/s12-zeem1020-v7a_tight-loose_skim.root 3708.0  800 @Powheg 10-20
#
# new n-tuples with finer binning
#
#a PATH_SSD/s12-zeem20to200-v7a_tight-loose_skim.root 1869.5   600 1 @Powheg 20-200
#a PATH_SSD/s12-zeem200to400-v7a_ntuple.root   1.3745     632 1 @Powheg 200-400
#a PATH_SSD/s12-zeem400to500-v7a_ntuple.root   0.06441    432 1 @Powheg 400-500
#a PATH_SSD/s12-zeem500to700-v7a_ntuple.root   0.03384    616 1 @Powheg 500-700
#a PATH_SSD/s12-zeem700to800-v7a_ntuple.root   0.004759   880 1 @Powheg 700-800
#a PATH_SSD/s12-zeem800to1000-v7a_ntuple.root  0.003695   900 1 @Powheg 800-1000
#a PATH_SSD/s12-zeem1000to1500-v7a_ntuple.root 0.0016255   625 1 @Powheg 1000-1500
#a PATH_SSD/s12-zeem1500to2000-v7a_ntuple.root 0.00014842  419 1 @Powheg 1500-2000
#a PATH_SSD/s12-zeem2000-v7a_ntuple.root 0.00002208  802 1 @Powheg 2000-
#
#  Ilya wrote on May 19, 2014
#> Sample: /DYJetsToLL_M-10To50filter_8TeV-madgraph/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM
#> Ntuple: /eos/cms/store/group/phys_smp/DYToEE_diff_xsec/ntuples/53X_with_regression/s12-zllm1050-v7a_ntuple.root
#> PREP cross section: 11050.0 pb
#> PREP filter efficiency: 0.069
#> 
#> Sample:/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM
#> Ntuple: /eos/cms/store/group/phys_smp/DYToEE_diff_xsec/ntuples/53X_with_regression/s12-zllm50-v7a_ntuple.root
