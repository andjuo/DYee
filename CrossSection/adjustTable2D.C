...
void adjustTable2D(int saveLatex=0, int saveStatErr=0) {
  ...
  if (0) {
    ...
    if (!saveLatexTable(fileTag + TString("-noStat"),histosV,labelsV,"%5.2lf",0,0))
      return;
  }
  ...
  TString fname="table" + DYTools::analysisTag + fileTag + TString("-noStat.tex");
