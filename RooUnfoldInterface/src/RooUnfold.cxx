...
//      $Id: RooUnfold.cxx 332 2012-01-27 20:43:58Z T.J.Adye $
//
// Description:
...
RooUnfold* RooUnfold::New (Algorithm alg, const RooUnfoldResponse* res, 
			   const TH1* meas, Double_t regparm,
...
#endif
    case kBasisSplines:
      unfold= new RooUnfoldBasisSplines( res, meas );
      break;
    default:
